...
/**
 * Implementación de una heurística basada en la distancia de Manhattan.
 * Esta heurística calcula la distancia entre dos puntos en un grid sumando las
 * diferencias
 * absolutas de sus coordenadas. Es útil en problemas donde los movimientos
 * están restringidos
 * a direcciones ortogonales (arriba, abajo, izquierda, derecha).
 */
public class HeuristicManhattanCliffPenalty implements Heuristic {
    ...
    /**
     * Calcula la heurística para un estado dado. La heurística se basa en la
     * distancia
     * de Manhattan, que es la suma de las diferencias absolutas de las coordenadas
    ...
    private double calculateHeuristic(State state) {
        ...
        // Heurística: h(n) = distancia_de_Manhattan
